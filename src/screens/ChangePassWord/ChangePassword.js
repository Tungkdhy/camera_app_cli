...
import { BackIcon, EyeIcon, UnEyeIcon } from '../../components/Icons/Index';
    ...
    try {
      ...
      if (e.response.status === 400) {
        if (
          ...
          Alert.alert(
            'Đổi mật khẩu không thành công, mật khẩu quá giống với email.',
          );
        }
        if (
          e.response.data.password[0] ===
          ...
          Alert.alert(
            'Đổi mật khẩu không thành công, mật khẩu quá giống với tên đăng nhập.',
          );
        }
                ...
                <SafeAreaView>
                  ...
                  <View style={styles.contain}>
                    <TextInput
                      ...
                      style={
                        submit && !isValidatePassword(password)
                  ...
                  <Text
                    ...
                    Mật khẩu dài 6 - 20 ký tự có ít nhất 1 ký tự viết hoa, 1 ký
                    tự viết thường, 1 ký tự đặc biệt, không chứa dấu cách hoặc
                    ký tự có dấu.
                  </Text>
                  ...
                  <View style={styles.contain}>
                    ...
                    <Pressable
                      ...
                      {newPassword.length > 0 &&
                        isValidateConfirm(newPassword, password) && (
