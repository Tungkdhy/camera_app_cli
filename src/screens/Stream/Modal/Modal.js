            ...
            <View style={styles.modalView}>
              ...
              <View style={styles.modalContent}>
                <View>
                  ...
                  <View style={styles.choose_camera}>
                    <RNPickerSelect
                      ...
                      items={
                        camera?.province ? camera.province.map(item => {
                          return {
                            key: item.code,
                            value: item.code,
                            label: item.name
                ...
                <View>
                  ...
                  <View style={styles.choose_camera}>
                    <RNPickerSelect
                      ...
                      items={
                        camera?.district ? camera.district.map(item => {
                          return {
                            key: item.code,
                            value: item.code,
                            label: item.name
                ...
                <View style={styles.action}>
                  <Pressable onPress={handleResetFilter} style={{ ...styles.btn, ...styles.reset }}>
                    <Text style={{ color: "rgba(0, 0, 0, 0.7)", fontWeight: 700 }}>Thiết lập lại</Text>
                  </Pressable>
                  <Pressable onPress={() => dispatch(setRefresh(!camera.refresh))} style={{ ...styles.btn, ...styles.primary }}>
